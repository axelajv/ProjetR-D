...
<header>
	...
	<div id="Date">
		 <a id="gaucheDate"  href="../controleurRecherche/AnneeMoins"><img alt="" src="../../assets/images/DateGaucheHeader.png"></a>
		
		 <label id="centreDate" value="<?php echo $Date;?>"><?php echo $Date;?></label>
		 
		 <a id="droiteDate"  href="../controleurRecherche/AnneePlus"><img alt="" src="../../assets/images/DateDroiteHeader.png"></a>
	</div>
...
echo "<h4>R&eacute;sultat de la recherche pour \"".$Keywords."\"</h4>";
	...
	<?php 
			...
			if ($Keywords == ""){
				echo "<h4>Veuillez saisir un mot clé pour votre recherche.</h4>";
			}
			else{
				echo "<h4>La recherche \"".$Keywords."\" n'a donnée aucun résultats.</h4>";
			}
		}
	?>
</div>
